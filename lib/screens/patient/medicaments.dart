      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // تم إزالة شريط الأيام من هنا
            const SizedBox(height: 10),

            // قائمة الأدوية (Stream من Supabase)
            Expanded(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Image.asset("assets/pharmacy.png", height: 100, errorBuilder: (c,e,s) => const Icon(Icons.local_pharmacy, size: 80),),
                  const SizedBox(width: 20),
                  Text(
                    widget.diseaseType,
                    style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () => setState(() => jour_selectionne = index),
                    child: Container(
                      margin: const EdgeInsets.symmetric(horizontal: 8),
                      width: 55,
                      decoration: BoxDecoration(
                        color: jour_selectionne == index ? Colors.red[300] : Colors.grey[300],
                        borderRadius: BorderRadius.circular(20),
                      ),
                      child: Center(
                        child: Text(
